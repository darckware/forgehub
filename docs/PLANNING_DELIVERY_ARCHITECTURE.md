...
Para a hierarquia completa dos documentos, consulte `docs/README.md`. O contrato operacional-alvo para execução por qualquer LLM está em `docs/ENGINEERING_LOOP.md`; a auditoria de lacunas e a ordem recomendada de implementação estão em `docs/IMPLEMENTATION_READINESS.md`.
