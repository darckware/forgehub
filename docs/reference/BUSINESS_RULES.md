...
| # | Rule | Enforcement |
|---|---|---|
| 1 | Every project must have an active pipeline | Not auto-created; caller must `POST /pipelines` — see `docs/reference/DATA_MODEL.md` §3.3 gap note |
